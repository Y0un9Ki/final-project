...
# 앱 내 import 
from .views import PerformanceList, PerformanceCreate, PerformanceDetail, PerformanceModify, CategoryList, CategoryDetail, ImageCreate, ImageDetail, PerformanceCategoryDetail, PerformanceMainList, ReservationCreate, ReservationList
...
urlpatterns = [
    ...
    path('performance/mainlist/', PerformanceMainList.as_view(), name='메인페이지에 공연리스트 보기'),
    path('performance/reserve/<int:pk>/', ReservationCreate.as_view(), name='공연 예약하기'),
    path('reservation/', ReservationList.as_view(), name='예약보기'),
]